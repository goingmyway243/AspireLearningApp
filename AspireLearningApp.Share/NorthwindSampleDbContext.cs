using AspireLearningApp.Share.Models;
using Microsoft.EntityFrameworkCore;

namespace AspireLearningApp.Share;

public partial class NorthwindSampleDbContext : DbContext
{
    public NorthwindSampleDbContext()
    {
    }

    public NorthwindSampleDbContext(DbContextOptions<NorthwindSampleDbContext> options)
        : base(options)
    {
    }
